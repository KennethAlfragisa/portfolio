    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-24">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <ScrollAnimationWrapper animationType="fade-up">
          <h1
            className="overflow-visible inline-block text-4xl md:text-6xl lg:text-7xl font-bold mb-12 
              leading-relaxed pb-4 shiny-text"
          >
        ...
        <div className="flex justify-center opacity-0 animate-fadeInDelay">
          <button
            ...
            className="animate-bounce cursor-pointer hover:scale-110 transition-transform duration-300 -mt-4 mb-8"
          >
        ...
        <style>
          {`
            ...
            /* Outline animated gradient for button */
            .outline-animated {
            ...
            /* Shimmer text effect for button label */
            .shimmer {
              position: relative;
            ...
            /* Shiny shimmer text (inside letters only) for heading */
            .shiny-text {
