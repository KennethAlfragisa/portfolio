    ...
    <section id="about" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-600 bg-clip-text text-transparent">
              ABOUT ME
            </h2>
          </motion.div>
          ...
          >
            <div className="w-32 h-1.5 bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-600 mx-auto origin-center rounded-full shadow-lg shadow-emerald-500/50" />
            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-40 h-5 bg-gradient-to-r from-emerald-400/30 via-teal-500/40 to-cyan-600/30 blur-md rounded-full" />
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
              viewport={{ once: false, amount: 0.3 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-teal-400 rounded-full shadow-lg shadow-teal-400/80"
            />
          </motion.div>
        </div>
